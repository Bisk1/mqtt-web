...
public interface MqttCallbackExtended extends MqttCallback {
	...
	/**
	 * Called when the session to the server is completed successfully.
	 * @param reconnect If true, the session was the result of automatic reconnect.
	 * @param serverURI The server URI that the session was made to.
	 */
