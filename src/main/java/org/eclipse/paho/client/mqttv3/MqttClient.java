...
public class MqttClient implements IMqttClient { //), DestinationProvider {
	 ...
	 * {@link MqttConnectOptions#setServerURI(String) setServerURIs} method
	...
	public void connect(MqttConnectOptions options) throws MqttSecurityException, MqttException {
		aClient.connect(options, null, null, null).waitForCompletion(getTimeToWait());
	}
	...
	public IMqttToken connectWithResult(MqttConnectOptions options) throws MqttSecurityException, MqttException {
		IMqttToken tok = aClient.connect(options, null, null, null);
	...
	public void subscribe(String[] topicFilters, int[] qos) throws MqttException {
		IMqttToken tok = aClient.subscribe(topicFilters, qos, null, null, null);
		tok.waitForCompletion(getTimeToWait());
	...
	/**
	 * Will attempt to reconnect to the server after the client has lost session.
