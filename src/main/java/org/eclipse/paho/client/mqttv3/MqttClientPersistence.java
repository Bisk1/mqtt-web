...
public interface MqttClientPersistence {
	 ...
	 * session will uniquely identify the persistence store required.
	 * 
	 * @param clientId The client for which the persistent store should be opened.
	 * @param serverURI The session string as specified when the MQTT client instance was created.
